...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'auctions.context_processors.add_context'
            ],
        },
    },
]
...
# set up the password recovery system
# We will send an email when the user requests for a password reset. 
# We will use Gmail for this purpose.
